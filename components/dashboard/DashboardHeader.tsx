  ...
  return (
    <header className="flex h-14 items-center justify-between border-b border-white/[0.07] bg-surface px-6">
      ...
      <div className="ml-auto flex items-center gap-4">
        ...
        <span className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full bg-white/[0.08] text-xs font-medium uppercase text-[rgba(250,250,250,0.7)]">
          {avatarUrl ? (
            <SupabaseImage
              src={avatarUrl}
              alt={username ?? 'avatar'}
